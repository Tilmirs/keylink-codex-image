...
- GPT Plus `gpt-image-2` 默认使用保守尺寸 `1024x1024`、`1536x1024`、`1024x1536`，按用户要求的画幅选择；平台没有公布尺寸时不假定 `2048x2048`。
...
- 默认分辨率策略是 GPT Plus 的保守 1K 尺寸：`1024x1024`、`1536x1024`、`1024x1536`。
